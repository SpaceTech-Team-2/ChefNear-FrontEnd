// الـ backend حالياً معندوش endpoint لجلب "طلباتي" (GET orders) ولا تفاصيل طلب معين.
// المتاح بس هو إنشاء الطلب (POST /Orders/checkout) وإجراءات عليه زي الإلغاء.
// عشان كده بنسجل كل طلب اتعمل فعليًا (رد الـ API نفسه) في localStorage، عشان
// المستخدم يقدر يشوف "طلباتي" ويتابع/يلغي الطلب من نفس المتصفح.
